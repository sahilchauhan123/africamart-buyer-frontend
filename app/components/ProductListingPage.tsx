        ...
        <div className="bg-[#f6f6f8] min-h-screen font-display antialiased flex flex-col animate-in slide-in-from-right duration-300">
            ...
            <main className="flex-1 pb-24">
                ...
                <div className="px-4 py-3 bg-white border-b border-slate-50">
                    <h1 className="text-xl font-black text-slate-900 leading-tight tracking-tight">{subCategoryName}</h1>
                    <p className="text-[10px] font-bold text-slate-400 mt-0.5 tracking-wider uppercase">Showing 1,240 verified products</p>
                </div>
